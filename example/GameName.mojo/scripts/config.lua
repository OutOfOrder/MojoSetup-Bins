local NOARCH_INSTALL_SIZE = 184601536 -- Change to the size of the noarch folder in bytes
local X86_INSTALL_SIZE = 8067512 -- Change to the size of the x86 folder in bytes
local X86_64_INSTALL_SIZE = 0 -- Change to the size of the x86_64 folder in bytes (if you have it.. otherwise 0)
...
local game_title = 'GameName' -- Change this to the full game name

Setup.Package
{
    vendor = "GameCompany.com", -- DNS domain of the game
    id = "GameName", -- short ID of the game name (the install folder)
        ...
        Setup.OptionGroup
        {
            ...
            Setup.Option
            {
                ...
                Setup.DesktopMenuItem
                {
                    ...
                    builtin_icon = false,
                    icon = "GameName.png",  -- Change the PNG Icon (relative to install dir)
                    commandline = "%0/GameName.bin.x86", -- Executable name (%0 is install dir)
                    workingdir = "%0",
                    category = "Game;"
                },
            },
            Setup.Option
            {
                ...
                Setup.DesktopMenuItem
                {
                    ...
                    builtin_icon = false,
                    icon = "GameName.png", -- Change the PNG Icon (relative to install dir)
                    commandline = "%0/GameName.bin.x86_64", -- Executable name (%0 is install dir)
                    workingdir = "%0",
                    category = "Game;"
                },
            },
